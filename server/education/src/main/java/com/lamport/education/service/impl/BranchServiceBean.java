...
import com.lamport.education.mapper.BranchMapper;
...
public class BranchServiceBean implements BranchService {
	...
	public String selectAllCategoryByQid(int qid) throws Exception {
		EnterpriseCategoryVo enterpriseCategoryVo = branchMapper.selectAllCategoryByQid(qid);
		List<BranchCategoryVo> branchCategoryVos = enterpriseCategoryVo.getBranchCategoryVo();
		JsonObject EnterpiseObj = new JsonObject(); // 添加分支
